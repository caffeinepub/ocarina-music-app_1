...
import { useDeleteScore, useGetAllScores } from "../hooks/useQueries";
...
export const ScoreLoadDialog: React.FC<ScoreLoadDialogProps> = ({
  open,
  onClose,
  onLoad,
}) => {
  ...
  const handleLoad = (score: {
    name: string;
    notes: Array<{ pitch: string; duration: bigint; fingering: string[] }>;
    lyrics?: string;
  }) => {
